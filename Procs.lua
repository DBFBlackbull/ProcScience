...
L.SetBonus = {
	...
	[21747] = { setName = "Lawbringer Armor", spellID = 23544, spellName = "Healing Circle",   school = L.SCHOOL.Physical, events = L.Events.SelfHeal, superWowEvents = L.Events.TargetSuperWow, description = "Gives the Paladin a chance on every melee hit to heal your party for 189 to 211." },
}
